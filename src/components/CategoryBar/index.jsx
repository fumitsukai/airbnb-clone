...
export function CategoryBar({ scroll }) {
  ...
  return (
    <>
      ...
      >
        <div
          className="flex justify-start mt-6 mb-4 gap-8 mx-5 overflow-hidden"
          id="list"
        >
          {categoryListItems}
          <button
          ...
          <button
            className="absolute start-20 rounded-full border p-1 hover:shadow-lg  bg-white"
            onClick={() => handleScroll(-1)}
          >
